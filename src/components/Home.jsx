    ...
    <div className="relative isolate px-6 pt-14 lg:px-8">
      ...
      >
        <div
          ...
          className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#00bf63] to-[##e4f577] opacity-80 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
        />
      </div>
    </div>
  );
