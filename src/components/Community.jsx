  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex-1 overflow-auto bg-white p-6">
        <header className="bg-white border border-gray-300 rounded-xl mb-6 px-4">
        ...
        <div className="bg-white border border-gray-300 rounded-xl p-16 mb-8 text-center">
        ...
        {posts && posts.length > 0 ? (
          posts.map((post) => (
            <motion.div
              ...
              className="bg-white border border-gray-300 rounded-xl p-6 mb-6 hover:shadow-xl transition-shadow duration-300"
            >
